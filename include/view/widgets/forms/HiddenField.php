 ...
 */
class HiddenField extends FormWidget
{
    ...
    public function build($preload)
    {
        ...
        $widget = new Skinlet("widget/HiddenField");
        ...
        $widget->setContent("value", $this->value);
 ...
 *
 */
class HiddenFieldFactory implements FormWidgetFactory
{
    public function create($form)
    {
        return new HiddenField($form);
    }
}
